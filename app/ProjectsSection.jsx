...
const projects = [
  ...
  },
  {
    ...
    desc: "Modern barbershop site with online booking and service showcase.",
  ...
  {
    title: "Urban Table",
    desc: "Restaurant site highlighting menu, reservations, and modern dining experience.",
...
export default function ProjectsSection() {
  ...
  const handleMouseEnter = (i) => {
    ...
    if (video) {
      video.currentTime = 0;
      video.play().catch(() => {}); // ignore autoplay interruptions
    }
  };
      ...
      <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
        {projects.map((project, i) => (
          <motion.a
            ...
            className="bg-gray-900 rounded-2xl overflow-hidden shadow-lg shadow-cyan-500/10 hover:shadow-cyan-500/30 transition-all duration-300"
          >
            <div className="overflow-hidden h-56 rounded-t-2xl relative">
              <video
                ref={(el) => (videoRefs.current[i] = el)}
                className="w-full h-full object-cover"
                poster={project.poster} // shows before playback
                muted
                loop
                playsInline
              >
